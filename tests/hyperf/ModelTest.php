...
use Chance\Log\Test\hyperf\model\Attribute;
use Chance\Log\Test\hyperf\model\Comment;
use Chance\Log\Test\hyperf\model\Connection;
use Chance\Log\Test\hyperf\model\DoNotRecordLog;
use Chance\Log\Test\hyperf\model\IgnoreLogFields;
use Chance\Log\Test\hyperf\model\Timestamps;
use Chance\Log\Test\hyperf\model\User;
...
class ModelTest extends TestCase
{
    ...
    public function testComment()
    {
        $mapping = [
            'test1' => [
                'tb_user' => 'Chance\Log\Test\hyperf\model\Comment',
            ],
        ];
    ...
    public function testAttribute()
    {
        $mapping = [
            'test' => [
                'tb_user' => 'Chance\Log\Test\hyperf\model\Attribute',
            ],
        ];
    ...
    public function testIgnoreLogFields()
    {
        $mapping = [
            'test' => [
                'tb_user' => 'Chance\Log\Test\hyperf\model\IgnoreLogFields',
            ],
        ];
    ...
    public function testDoNotRecordLog()
    {
        OperationLog::setTableModelMapping([
            'test' => [
                'tb_user' => 'Chance\Log\Test\hyperf\model\DoNotRecordLog',
            ],
        ]);
        $data = mockData();
